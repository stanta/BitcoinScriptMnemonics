...
# Locktime 
#Word	Opcode	Hex	Input	Output	Description
OP_CHECKLOCKTIMEVERIFY	=177	;# 0xb1	Nothing	Nothing/ False	This word is ignored and does nothing until BIP65 is enforced. Marks transaction as invalid if the top stack item is greater than the transaction's nLockTime field, otherwise script evaluation continues as though an OP_NOP was executed. Transaction is also invalid if 1. the top stack item is negative; or 2. the top stack item is greater than or equal to 500000000 while the transaction's nLockTime field is less than 500000000, or vice versa; or 3. the input's nSequence field is equal to ;# 0xffffffff. The precise semantics are described in BIP 0065

#Pseudo-words 
#Word	Opcode	Hex	Description	Word	Opcode
OP_PUBKEYHASH=	253	;# 0xfd	Represents a public key hashed with OP_HASH160.	OP_PUBKEYHASH	253
OP_PUBKEY=	254	;# 0xfe	Represents a public key compatible with OP_CHECKSIG.	OP_PUBKEY	254
OP_INVALIDOPCODE=	255	;# 0xff	Matches any opcode that is not yet assigned.	OP_INVALIDOPCODE	255
# Reserved 
